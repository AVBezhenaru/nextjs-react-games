...
export default class L extends Figure {
  constructor(cells?: CellModel[], displacementX?: number, displacementY?: number, rotate?: Rotate) {
    ...
    if (!cells) {
      this.cells.push(new CellModel(0, 0, true)); // ooo
  ...
  nextRotate(): Figure {
    switch (this.rotate) {
      ...
      case Rotate.NINETY_DEG:
        return new L(
          [
            new CellModel(2, 0, true), //   o
            new CellModel(0, 1, true), // ooo
            new CellModel(1, 1, true),
            new CellModel(2, 1, true),
          ],
          this.displacementX,
          this.displacementY,
      ...
      case Rotate.TWO_HUNDRED_SEVENTY_DEG:
        return new L(null, this.displacementX, this.displacementY, Rotate.ZERO_DEG);
      default:
        return this;
    }
  }
